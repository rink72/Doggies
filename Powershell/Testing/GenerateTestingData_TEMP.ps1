...
{
    $trainLinesQuery = "SELECT RACEID, DOGID FROM TRAININGDATA WHERE D_1_M1 is NULL"
...
$RaceQuery = "SELECT [DOGID], [RACEID] FROM RESULTS where raceid not in (SELECT DISTINCT RACEID FROM TRAININGDATA)"
