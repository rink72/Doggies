...
PredictFutureResults <- function()
{
	...
	query1 = "SELECT [RACEID],[DOGID],[D_1_M],[D_2_M],[D_3_M],[D_1D_A],[D_2D_A],[D_3D_A],[D_P_A],[D_P_M],[D_PT_A],[D_PB_A],[D_R_M],[D_PWC_A],[D_PTC_A] FROM [Racing].[dbo].[FUTUREDATA] ORDER BY newID()"
	query2 = "SELECT [RACEID],[DOGID],[D_1_M],[D_2_M],[D_3_M],[D_1D_A],[D_2D_A],[D_3D_A],[D_P_A],[D_P_M],[D_PB_A],[D_R_M],[D_PWC_A],[D_PTC_A] FROM [Racing].[dbo].[FUTUREDATA] ORDER BY newID()"
	query3 = "SELECT [RACEID],[DOGID],[D_1_M],[D_2_M],[D_3_M],[D_1D_A],[D_2D_A],[D_3D_A],[D_P_M],[D_PB_A],[D_R_M],[D_PWC_A],[D_PTC_A] FROM [Racing].[dbo].[FUTUREDATA]ORDER BY newID()"
